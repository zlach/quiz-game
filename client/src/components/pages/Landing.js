            ...
            <div className="container">
                ...
                <div className="row justify-content-center pt-5">
                    <div className="manager" style={{ display: isCode ? 'block' : 'none' }}>
                        click to{" "}
                        <span className="here" onClick={() => { setIsCode(false); setFormType('login') }}>login</span>
                        {" "}or{" "}
                        <span className="here" onClick={() => { setIsCode(false); setFormType('login') }}>register</span>
                    </div>
                </div>
            </div>
